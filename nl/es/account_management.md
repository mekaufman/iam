...
| Editor |  Todas las acciones del rol de editor para los servicios de gestión de cuentas     |
| Administrador |  Todas las acciones del rol de administrador para los servicios de gestión de cuentas   |

...
下表提供了用户可以在目录资源和资源组的上下文中执行的一些平台管理操作示例。请参阅每个目录产品的文档，以了解这些角色如何在所使用的服务上下文中应用于用户。
...
有关用户基于其在帐户管理服务上所分配角色可以执行的特定操作的信息，请参阅[分配对帐户管理服务的访问权](/docs/iam?topic=iam-account-services)。
{: #acctmgmt}

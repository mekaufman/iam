...
![建立 IAM 原則](images/IAM.svg "如何使用主體、目標及角色來建立 IAM 存取原則"){: caption="圖 1. 如何使用主體、目標及角色來建立 IAM 存取原則" caption-side="bottom"}
...
如需使用者可根據其帳戶管理服務獲指派角色所採取之特定動作的相關資訊，請參閱[指派帳戶管理服務的存取權](/docs/iam?topic=iam-account-services)。
{: #acctmgmt}

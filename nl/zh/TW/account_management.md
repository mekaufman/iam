...
您可以使用存取群組帳戶管理服務，為使用者提供檢視、建立、編輯和刪除帳戶中存取群組的存取權。
...
您可以提供使用者存取權，來檢視帳戶中的使用者、邀請和移除使用者，以及利用使用者管理帳戶管理服務來檢視及更新使用者設定檔設定。
...
使用者管理服務上的檢視者角色，對於也被指派角色來檢視或管理支援案例的使用者而言，是一個常見指派的角色。這是因為如果帳戶擁有者在 IAM 設定中限制使用者清單的可見性，可能會導致使用者無法看到由帳戶中其他使用者開立的支援案例。不過，如果他們獲指派使用者管理服務的檢視者角色，則該使用者清單可見性設定不會影響他們能否在帳戶中檢視案例。
{: tip}

### 支援中心
{: #support-center-account-management}

您可以藉由使用支援中心服務，提供使用者管理支援案例的存取權。
...
常見到會指派使用者管理服務的檢視者角色給使用者，以及支援中心存取原則，以便確定使用者可以看到帳戶中的所有案例，而不管帳戶擁有者如何設定使用者清單可見性設定。如果使用者清單可見性設定設為受到限制，以致使用者受到限制無法看到帳戶中的其他使用者，則這可能會限制使用者能否檢視、搜尋及管理帳戶中他們自己未開立的支援案例。
{: tip}
...
|角色|動作|
|:-------|----------|
|檢視者|檢視帳戶特性設定<br><br> 檢視帳戶中的訂閱<br><br> 檢視帳戶名稱|
|操作員|檢視帳戶特性設定<br><br> 檢視帳戶中的訂閱<br><br> 檢視及變更帳戶名稱|
|編輯者|檢視及更新帳戶特性設定<br><br> 檢視帳戶中的訂閱<br><br> 檢視帳戶中的供應項目<br><br> 檢視及套用訂閱和特性碼<br><br> 檢視及變更帳戶名稱<br><br> 檢視及更新消費限制|
|管理者|檢視及更新帳戶特性設定<br><br> 檢視帳戶中的訂閱<br><br> 檢視帳戶中的供應項目<br><br> 檢視及套用訂閱和特性碼<br><br> 檢視及變更帳戶名稱<br><br> 檢視及更新消費限制<br><br> 檢視訂閱餘額及追蹤用量<br><br> 建立企業|
{: caption="表 4. 「計費」服務的角色與範例動作" caption-side="top"}

### IAM 身分服務
{: #identity-service-account-management}

您可以藉由使用 IAM 身分服務，提供使用者管理服務 ID 的存取權。對於 IAM 身分服務，這些動作適用於帳戶中使用者未建立的服務 ID。所有使用者都可以建立服務 ID。他們是那些 ID 的管理者，而且可以建立相關聯的 API 金鑰及存取原則。不過，此帳戶管理服務會套用至對其他使用者所建立帳戶中的服務 ID 進行檢視、刪除及指派存取權的能力。
...
您可以使用全球型錄服務，提供使用者存取權，以檢視型錄中的專用服務，或變更其他使用者對專用服務的可見性。
...
企業服務用於指派使用者管理企業的存取權，方法為在企業內建立帳戶、將帳戶指派給帳戶群組、命名帳戶群組等等。只有在企業帳戶內指派此原則時，該類型原則才有效。 

|角色|動作|
|:-------|----------|
|檢視者|檢視企業、帳戶群組及帳戶|
|操作員|檢視企業、帳戶群組及帳戶|
|編輯者|檢視及更新企業（包括名稱及網域）、建立帳戶及帳戶群組、檢視用量報告，以及匯入帳戶|
|管理者|檢視及更新企業（包括名稱及網域）、建立帳戶及帳戶群組、在帳戶群組之間移動帳戶、匯入現有帳戶，以及檢視用量報告|
|用量報告檢視者|檢視企業、帳戶及帳戶群組，以及檢視企業中所有帳戶的用量報告|
{: caption="表 7.「企業」服務的角色與範例動作" caption-side="top"}


### 所有帳戶管理服務選項
{: #all-account-management}

若要快速提供使用者廣泛的帳戶管理存取權集合，您可以指派所有帳戶管理服務選項的原則。依所選取的角色而定，原則的主體可以完成每個帳戶管理服務之所選角色的所有適用動作。
...
{: caption="表 8. 所有身分及存取服務上原則的角色與範例動作" caption-side="top"}

...
ユーザー管理サービスのビューアー役割は、通常、サポート Case を表示または管理するための役割も割り当てられるユーザーに割り当てられる役割です。 これは、アカウント所有者が IAM 設定でユーザー・リストの可視性を制限した場合に、ユーザーがアカウントの他のユーザーがオープンしたサポート Case を表示できなくなる可能性があるためです。 しかし、ユーザー管理サービスのビューアー役割が割り当てられていれば、ユーザーはユーザー・リストの可視性設定に影響されずにアカウントの Case を表示できます。
{: tip}
...
アカウント所有者がユーザー・リストの可視性設定をどのように設定したかに関係なく、ユーザーがアカウントのすべての Case を確実に表示できるようにするには、サポート・センターのアクセス・ポリシーに加えてユーザー管理サービスのビューアー役割をユーザーに割り当てるのが一般的です。 ユーザー・リストの可視性設定が「制限付き」に設定され、アカウントの他のユーザーの表示を制限されると、アカウントのサポート Case のうちユーザーが自分でオープンしなかったものを表示、検索、および管理する権限が制限される可能性があります。
{: tip}
...
| 役割 | アクション |
|:-------|----------|
| ビューアー | アカウント機能設定の表示 <br><br> アカウント内のサブスクリプションの表示 <br><br> アカウント名の表示 |
| オペレーター | アカウント機能設定の表示 <br><br> アカウント内のサブスクリプションの表示 <br><br> アカウント名の表示および変更    |
| エディター |  アカウント機能設定の表示および更新 <br><br> アカウント内のサブスクリプションの表示 <br><br> アカウント内のオファーの表示 <br><br> サブスクリプション・コードおよびフィーチャー・コードの表示および適用 <br><br> アカウント名の表示および変更 <br><br> 消費量限度の表示および更新  |
| 管理者 |  アカウント機能設定の表示および更新 <br><br> アカウント内のサブスクリプションの表示 <br><br> アカウント内のオファーの表示 <br><br> サブスクリプション・コードおよびフィーチャー・コードの表示および適用 <br><br> アカウント名の表示および変更 <br><br> 消費量限度の表示および更新 <br><br> サブスクリプション残高の表示と使用量の追跡 <br><br> エンタープライズの作成  |
{: caption="表 4. 請求処理サービスの役割とアクション例" caption-side="top"}

### IAM Identity サービス
{: #identity-service-account-management}

IAM Identity サービスを使用して、サービス ID を管理するアクセス権限をユーザーに付与できます。 IAM Identity サービスでは、これらのアクションは、ユーザーが作成しなかった、アカウント内のサービス ID に適用されます。 すべてのユーザーがサービス ID を作成できます。ID を作成したユーザーはそれらの ID の管理者であり、関連付けられた API キーおよびアクセス・ポリシーを作成することができます。 ただし、このアカウント管理サービスは、他のユーザーによって作成されたアカウント内のサービス ID の表示、削除、およびサービス ID へのアクセス権限の割り当てを行う権限に適用されます。

...
![IAM 정책 작성](images/IAM.svg "주체, 대상 및 역할을 사용하여 IAM 액세스 정책을 작성하는 방법"){: caption="Figure 1. How IAM access policies are created by using a subject, target, and role" caption-side="bottom"}

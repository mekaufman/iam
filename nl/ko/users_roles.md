...
표의 첫 번째 행에서는 정책을 작성할 때 선택할 수 있는 개별 옵션을 설명하고 첫 번째 열에서는 정책의 선택된 역할을 설명합니다. 나머지 셀은 첫 번째 열에서 선택한 역할 및 첫 번째 행의 옵션에서 선택한 정책 유형에 맵핑됩니다.
...
표의 첫 번째 행에서는 정책을 작성할 때 선택할 수 있는 특정 서비스를 설명하고 첫 번째 열에서는 정책의 선택된 역할 유형을 설명합니다. 나머지 셀은 첫 번째 열의 옵션에서 선택한 역할 및 첫 번째 행의 옵션에서 선택한 정책 유형에 맵핑됩니다.

| 액세스 정책 세부사항 |  서비스 ID에 대한 조치  | 액세스 그룹 관리 조치 | 카탈로그 액세스 관리 조치 | 사용자를 관리하기 위한 액세스에 대한 조치 | 지원을 위한 조치 | 청구 조치 | 모든 계정 관리 서비스를 위한 조치 |
|:--------------|:-------------|:--------------|:--------------|:-----------|:--------------|:--------------|:--------------|
|  |IAM ID 서비스 |  IAM 액세스 그룹 |  글로벌 리소스 카탈로그 |  사용자 관리  |지원 센터 |청구 및 사용량 |  모든 계정 관리 서비스 |
|뷰어 역할 |  <ul><li>ID 보기</li></ul> |  <ul><li>액세스 그룹 및 구성원 보기</li></ul> | <ul><li>개인 서비스 보기</li></ul>  |  <ul><li>계정의 사용자 보기</li><li>사용자 프로파일 설정 보기</li></ul> | <ul><li>케이스 보기</li><li>케이스 검색</li></ul> | <ul><li>계정 기능 설정 보기</li><li>계정의 구독 보기</li><li>계정 이름 보기</li><li>리소스 그룹 보기</li></ul> | 계정 관리 서비스의 모든 뷰어 역할 조치 |
|운영자 역할 | <ul><li>ID 및 API 키 작성 및 삭제</li></ul> |  <ul><li>해당사항 없음</li></ul> | <ul><li>해당사항 없음</li></ul> |  <ul><li>계정의 사용자 보기</li><li>사용자 프로파일 설정 보기</li></ul> | <ul><li>해당사항 없음</li></ul> | <ul><li>계정 기능 설정 보기</li><li>계정의 구독 보기</li><li>계정 이름 보기 및 변경</li><li>리소스 그룹 보기 및 업데이트</li></ul> | 계정 관리 서비스의 모든 운영자 역할 조치 |
|편집자 역할 |  <ul><li>ID 및 API 키 작성, 업데이트, 삭제</li></ul> |  <ul><li>그룹 보기, 작성, 편집, 삭제</li><li>그룹에서 사용자 추가 또는 제거</li></ul> | <ul><li>오브젝트 메타데이터를 변경할 수 있지만 개인 서비스에 대한 가시성을 변경할 수는 없음</li></ul>  | <ul><li>계정에서 사용자 보기, 초대, 제거 및 업데이트</li><li>사용자 프로파일 설정 보기 및 업데이트</li></ul> |  <ul><li>케이스 보기</li><li>케이스 검색</li><li>케이스 업데이트</li><li>케이스 작성</li></ul> | <ul><li>계정 기능 설정 보기 및 업데이트</li><li>계정의 구독 보기</li><li>계정에서 오퍼 보기</li><li>기능 코드 보기 및 적용</li><li>계정 이름 보기 및 변경</li><li>지출 한계 보기 및 업데이트</li><li>리소스 그룹 보기, 작성, 업데이트</li></ul> | 계정 관리 서비스의 모든 편집자 역할 조치 |
|관리자 역할 |   <ul><li>ID 및 API 키 작성, 업데이트, 삭제</li><li>ID에 액세스 정책 지정</li></ul> |  <ul><li>그룹 보기, 작성, 편집, 삭제</li><li>사용자 추가 또는 제거</li><li>그룹에 액세스 권한 지정</li><li>액세스 그룹을 사용하여 작업하도록 액세스 관리</li></ul> | <ul><li>개인 서비스의 가시성 또는 오브젝트 메타데이터를 변경하고 퍼블릭 서비스의 가시성을 제한할 수 있음</li></ul> | <ul><li>계정에서 사용자 보기, 초대, 제거 및 업데이트</li><li>사용자 프로파일 설정 보기 및 업데이트</li></ul> |  <ul><li>케이스 보기</li><li>케이스 검색</li><li>케이스 업데이트</li><li>케이스 작성</li></ul> |  <ul><li>계정 기능 설정 보기 및 업데이트</li><li>계정의 구독 보기</li><li>계정에서 오퍼 보기</li><li>기능 코드 보기 및 적용</li><li>계정 이름 보기 및 변경</li><li>지출 한계 보기 및 업데이트</li><li>구독 밸런스 보기 및 사용량 추적</li><li>리소스 그룹을 관리하기 위한 액세스 보기, 작성, 업데이트 및 지정</li></ul> | 계정 관리 서비스의 모든 관리자 역할 조치|

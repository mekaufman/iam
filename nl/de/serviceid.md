...
- {{site.data.keyword.objectstorageshort}} - [Verwendung der {{site.data.keyword.Bluemix_notm}}-Befehlszeilenschnittstelle](/docs/services/cloud-object-storage?topic=cloud-object-storage-ic-use-the-ibm-cli#ic-hmac-credentials).
